    ...
    <AppShell title="Scope">
      <Container size="xl">
        ...
        <div className="content-grid section">
          <div>
            <Card>
              <div className="section-title">Scope items</div>
              <table className="table section-sm">
                <thead>
                  <tr>
                    <th>Item</th>
            ...
            <Card className="section">
              ...
              <div className="input-group">
                <div className="input-label">Builder notes</div>
                <input placeholder="Allow for protective floor coverings" />
              </div>
            </Card>
            ...
            <Card className="section">
              ...
              <div className="input-group">
                <div className="input-label">Inclusions</div>
                <input placeholder="Standard hardware and joinery finishes" />
              </div>
            </Card>
